...
public class SubfolderDistributionModule extends AbstractModule {
	...
	protected void configure() {
		MapBinder.newMapBinder(binder(), String.class, PathStrategy.class).addBinding(STRATEGY_NAME)
				.to(SubfolderDistributionStrategy.class);
		bind(SubfolderDistributionConfiguration.class).toProvider(ParsedSubfolderDistributionConfigProvider.class);
	}
